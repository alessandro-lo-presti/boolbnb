          ...
          <div class="card-body">
            ...
            <form action="{{route('apartment.update', $apartment)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <input type="file" class="form-control-file" id="apartment_images" name="apartment_images[]" multiple value="{{asset('storage/'.$apartment->image)}}">
                </div>
              </div>
                ...
                <div class="form-group row col-6">
                  <div class="counter d-flex justify-content-start">
                    ...
                    <div class="counter-number d-flex justify-content-around">
                      ...
                      <span :class="phpRooms">{{$apartment->n_rooms}}</span>
                      <span :class="vueRooms">@{{rooms}}</span>
                ...
                <div class="form-group row col-6">
                  <div class="counter d-flex justify-content-star">
                    ...
                    <div class="counter-number d-flex justify-content-around">
                      ...
                      <span :class="phpBeds">{{$apartment->n_beds}}</span>
                      <span :class="vueBeds">@{{beds}}</span>
                ...
                <div class="form-group row col-6">
                  <div class="counter d-flex justify-content-star">
                    ...
                    <div class="counter-number d-flex justify-content-around">
                      ...
                      <span :class="phpBathrooms">{{$apartment->n_bathrooms}}</span>
                      <span :class="vueBathrooms">@{{bathrooms}}</span>
                ...
                <div class="form-group row col-6">
                  <div class="counter d-flex justify-content-star ">
                    ...
                    <div class="counter-number d-flex justify-content-around">
                      ...
                      <span :class="phpMq">{{$apartment->mqs}}</span>
                      <span :class="vueMq">@{{mq}}</span>
                ...
                <div class="services row">
                  @foreach ($services as $service)
                    <div class="form-group row form-check offset-1 col-5">
                      <input type="checkbox" class="form-check-input" id="{{$service->id}}" name="services[]" value="{{$service->id}}" {{$apartment->services->contains($service->id) ? 'checked' : ''}}>
